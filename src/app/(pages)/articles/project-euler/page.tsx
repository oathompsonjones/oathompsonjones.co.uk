        ...
        <article>
            ...
            <Glass>
                ...
                <Typography variant="body1">
                    ...
                    elegant and efficient methods, the use of a computer and programming skills will be required to
                    solve most problems.
                    <br /><br />
                    The motivation for starting Project Euler, and its continuation, is to provide a platform for the
                    inquiring mind to delve into unfamiliar areas and learn new concepts in a fun and recreational
                    context.
                </Typography>
                <Typography variant="h3">
                ...
                <Typography variant="body1">
                    ...
                    learn, adults whose background was not primarily mathematics but had an interest in things
                    mathematical, and professionals who want to keep their problem solving and mathematics on the
                    cutting edge.
                    <br /><br />
                    Currently we have 1376731 registered members who have solved at least one problem, representing 220
                    locations throughout the world, and collectively using 114 different programming languages to solve
                    the problems.
                </Typography>
                <Typography variant="h3">
                ...
                <Typography variant="body1">
                    The problems range in difficulty and for many the experience is inductive chain learning. That is,
                    by solving one problem it will expose you to a new concept that may allow you to undertake a
                    previously inaccessible problem. So determined participants will be able to slowly but surely work
                ...
                <Typography variant="body1">
                    As a brief overview of my GitHub profile will tell you, my prefered programming language is
                    TypeScript.
                    ...
                    Aside from the language limitations, many of my solutions are not as algorithmically efficient as
                    they could be, however, they do all run in a reasonable time frame on my laptop.
                    <br /><br />
