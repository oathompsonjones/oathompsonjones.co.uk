/**
 * Takes in an set of key-value pairs representing variables to be declared in CSS, and embeds them in a style tag.
 * Automatically adds `--` to the start of the variable name when embedding it inside the style tag.
 *
