    ...
    const skills: Array<{ content: ReactElement; heading: string; }> = [
        {
            ...
            content: (
                <>
                    ...
                    asked to represent the school (and my family) during the memorial service for a former headmaster,
                    <a href="https://tbshs.org/ian-shaw-tbshs-1980-1998/">Ian Shaw</a>.
                </>
            ),
